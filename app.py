...
load_dotenv()
app = Flask(__name__)
#"The SECRET_KEY is a cryptographic string used by Flask to securely sign the session cookies. This prevents users from tampering with the cookie. Without it, a user could manually edit their cookie to change their user_id to '1' and trick the server into thinking they are the Admin. The secret key ensures the cookie was generated by my server and hasn't been altered."
